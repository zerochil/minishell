...
/*   Updated: 2025/01/25 11:49:37 by rrochd           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_WORD_OR_REDIR \
"syntax error near unexpected token: expected word or redirection"
# define ERR_MISSING_FILENAME \
"syntax error near unexpected token: missing filename"
# define ERR_EMPTY_COMMAND \
"syntax error near unexpected token: empty command"
# define ERR_UNFINISHED_PIPE \
"syntax error near unexpected token: unfinished pipe"
# define ERR_CLOSE_PARENTHESIS \
"syntax error near unexpected token: missing close parenthesis"
...
t_array			*consume_until(t_array *tokens, bool is_target(int),
					bool to_skip(int), bool is_error(t_token *));
